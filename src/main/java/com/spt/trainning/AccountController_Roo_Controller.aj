...
import com.spt.trainning.AccountController;
...
privileged aspect AccountController_Roo_Controller {
    ...
    void AccountController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("account_createddate_date_format", "dd/MM/yyyy");
        uiModel.addAttribute("account_updateddate_date_format", "dd/MM/yyyy");
    }
